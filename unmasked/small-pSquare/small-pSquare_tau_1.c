...
void __attribute__((noinline)) Encrypt(const uint8_t *plaintext, const uint8_t* key, const uint8_t* tweak, uint8_t *ciphertext);
void __attribute__((noinline)) Decrypt(const uint8_t *ciphertext, const uint8_t* key, const uint8_t* tweak, uint8_t *plaintext);
